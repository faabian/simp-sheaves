...
Hausdorffraum liefert.

Bezeichne dazu $||X^{\leq k}|| = \coprod_{0 \leq n \leq k} NX_n \times
...
keine neuen Identifikationen auf den Teilmengen $||X^{\leq k} \subset
||X||$ hinzu.

Wir können die $||X^{\leq k}||$ iterativ konstruieren. Setze dazu
$||X^{\leq 0}|| = X_0$ mit der diskreten Topologie. Nun ist $||X^{\leq
  k}||$ der Pushout topologischer Räume
