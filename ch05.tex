...
\begin{proof}
  ...
  \begin{align*}
     ...
     & \iso \int_{[n]} \Top \big( X([n]) \times R[n], Y \big) \\
     & \iso \int_{[n]} \Ens \big( X([n]), \Top(R[n], Y) \big) \\
     & \iso [\Delta\op, \Ens] \big( X, \Top(R \cdot, Y) \big) \\
     &= \s\Ens(X, SY).
  \end{align*}
\end{proof}

% TODO:
% * Koenden-Kalkül s.o. fertig
% * allgemeine Nerv-Realisierung-Dualität
