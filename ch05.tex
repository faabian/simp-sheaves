...
\begin{prop}[\cite{Vogt}, 5]
  ...
  \end{enumerate}
\end{prop}
Für Axiom \ref{itm:k-axiom-subspace} weisen wir das nach. Da es sich
um eine lokale Eigenschaft handelt, gilt die Aussage im Fall der
...
\begin{proof}
  ...
  Isomorphismus als die Koeinheit der Adjunktion $(ét, S)$ aus
...
in der Basis dargestellt hat, schränken wir uns einfach auf eine
bequemere Kategorie ein.
\begin{Satz}
