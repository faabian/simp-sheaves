...
\to Y)$ mit étalen Abbildungen nicht wieder étale. Für die volle
Unterkategorie $\Ens_{\K} \subset \K^I$ der étalen Räume über
$\K$-Räumen benötigen wir daher wieder eine koreflektive
Struktur. Diese ist gegeben durch die ``Étalisierung'':
\begin{lemma}[\cite{TG}, 2.1.40]
  Für $X$ einen topologischen Raum besitzt die Inklusion $\etTop_X
  \inj \Top_X$ einen Rechtsadjungierten, genannt die
  \emph{Etalisierung}.
\end{lemma}
\begin{proof}
  % TODO
