...
\begin{defn}[\cite{Steenrod}]
  Ein Hausdorffraum $X$ heißt kompakt erzeugt, falls jede Teilmenge
  $A \subset X$, für die $A \cap K$ abgeschlossen ist für jedes
  Kompaktum $K \subset X$, selbst bereits abgeschlossen ist in $X$.
\end{defn}
...
Für uns relevant ist das folgende Kriterium:
\begin{lemma}
  % ?? was brauchen wir eig?
\end{lemma}
