...
\end{satz}
\begin{proof}
  %% was bringt eig. homotopieinjektiv? erst später benötigen wir:

  %% Mit \cite{TD}, 3.6.10, finden wir eine homotopieinjektive Auflösung
  %% von $F$ durch injektive, also inbesondere $\beta$-azyklische Garben
  %% (vgl. \ref{sk-is-acyc}).
