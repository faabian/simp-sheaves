...
\begin{prop}
  ...
  \mapsto \hat{F}$, der einen Funktor von der Kategorie der Kokeile
  für $F$ in die Kategorie der Kokegel für $\hat{F}$ induziert.
\end{prop}
\begin{proof}
  % TODO
\end{proof}
\begin{bem}
  % TODO: twisted arrow category ist sogar äquivalent, aber wir
  % benötigen die Verallgemeinerung
\end{bem}
