...
Situation elegant ist, sie darauf beruht, dass sich die ``Wirkung''
von $\Ens$ auf $\Top$ $(X_n, |\Delta^n|) \mapsto \coprod_{X_n}
|\Delta^n|$, wie wir sie im folgenden Abschnitt formal erklären,
darstellen lässt über den $\Delta^n$-Anteil der Simplexkategorie. Dies
wird bei ``Wirkungen'' wie von $\Top$ auf $\Top$ durch das kartesische
Produkt nicht mehr der Fall sein.
...
\begin{proof}
  ...
  \ref{eq:???} und folglich das angegebene Ende.
\end{proof}
