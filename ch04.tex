...
\begin{bem} \label{clumsy-real}
  ...
  die \emph{plumpen Standard-$n$-Simplizes $\blacktriangle^n} induktiv
  als Quotienten:
...
\begin{lemma}
  ...
  monotones $f: [m] \to [n]$ induzieren stetige Abbildungen $|f|:
  \blacktriangle^m \to \blacktriangle^n$.
\end{lemma}
\begin{proof}
  Für die Randabbildungen $|d_i|$ folgt das sofort aus der Definition
  der Äquivalenzrelation. Für die Degenerationen $|s_i|$ 
  % TODO
\end{proof}
% = Funktor = kosimplizialer Raum
