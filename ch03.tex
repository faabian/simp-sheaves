...
\end{satz}
\begin{proof}
  Sei $F \in \p C_{/X}$. Wir behaupten, dass $F^+(U) :=
  \colf\limits_{\mathcal{U}} \lim_i F(U_i)$ eine Garbe ist und die
  Adjunktionseigenschaft erfüllt. Der Kolimes wird dabei über das
  filtrierende System aller gesättigten Überdeckungen $U =
  \bigcup_{U_i \in \mathcal{U}} U_i$ gebildet. Die Konstruktion ist
  funktoriell.
...
Verallgemeinerte Garbifizierung
